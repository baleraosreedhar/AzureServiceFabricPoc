...
namespace MyUtils.Helpers
{
    ...
    public class CommonHelper
    {
        ...
        /// <returns></returns>
        /// <exception cref="PortfolioException">Email is not valid.</exception>
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            if (!IsValidEmail(output))
                throw new PortfolioException("Email is not valid.");
        ...
        /// <returns>
        /// Input string if its lengh is OK; otherwise, truncated input string
        /// </returns>
        ...
        /// propertyName
        /// </exception>
        /// <exception cref="PortfolioException">
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new PortfolioException("No property '{0}' found on the instance of type '{1}'.", propertyName,
                    instanceType);
            if (!pi.CanWrite)
